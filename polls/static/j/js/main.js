...
$(document).on('click', '#dataViews > span', function() {
	...
	// don't do anything unless we click a new view
	if (!$(this).hasClass('selected')) {
		var htmlID = $(this).attr('id');
		if (htmlID == 'freqView')
			console.log('load freq view');
		else if (htmlID == 'genderView')
			console.log('load gender view');
		else if (htmlID == 'ageView')
			console.log('load age view');
		else if (htmlID == 'mapView')
			console.log('load map view');
		else if (htmlID == 'musicView')
			console.log('load music view');
	}
